...
from expirement_er.bertMRC.data_loader.mrc_utils import convert_examples_to_features
...
class MRCNERDataLoader(object):
    ...
    def get_dataloader(self, data_sign="train"):
        ...
        dataset = TensorDataset(input_ids, input_mask, output_mask, segment_ids, start_pos, end_pos, span_pos, ner_cate)
