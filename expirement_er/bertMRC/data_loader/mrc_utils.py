...
import numpy 
import numpy as np
from expirement_er.bertMRC.data_loader.bert_tokenizer import whitespace_tokenize
...
def convert_examples_to_features(examples, tokenizer, label_lst, max_seq_length, is_training=True, 
    ...
    for (example_idx, example) in enumerate(examples):
        ...
        flag = False
        for i in example.end_position:
            if i > len(example.context_item):
        ...
        output_mask.extend([1]* len(all_doc_tokens))
