...
from expirement_er.bertMRC.layer.classifier import MultiNonLinearClassifier
from expirement_er.bertMRC.layer.bert_basic_model import BertModel, BertConfig
...
class BertQueryNER(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, 
        start_positions=None, end_positions=None, span_positions=None, output_mask=None):
        """
        Args:
        ...
        # start_logits = self.dropout(start_logits)
        # end_logits = self.dropout(end_logits)
