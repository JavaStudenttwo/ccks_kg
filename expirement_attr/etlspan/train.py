...
parser.add_argument('--data_dir', type=str, default='dataset/baiduRE20/data')
parser.add_argument('--vocab_dir', type=str, default='dataset/baiduRE20/vocab')
parser.add_argument('--word_emb_dim', type=int, default=1024, help='Word embedding dimension.')
...
parser.add_argument('--obj_input_dim', type=int, default=3092, help='RNN hidden state size.')
...
parser.add_argument('--log_step', type=int, default=800, help='Print log every k steps.')
parser.add_argument('--log', type=str, default='logs.txt', help='Write training log to file.')
parser.add_argument('--save_epoch', type=int, default=50, help='Save model checkpoints every k epochs.')
parser.add_argument('--save_dir', type=str, default='./saved_models/minibaiduRE20/5_16_bert_2', help='Root dir for saving models.')
parser.add_argument('--id', type=str, default='00', help='Model ID under which to save models.')
parser.add_argument('--info', type=str, default='', help='Optional info for the experiment.')

parser.add_argument('--bert_model', type=str, default='dataset/embedding/chinese_roberta_wwm_large_ext_pytorch', help='bert模型位置')
...
# load data
train_data = json.load(open(opt['data_dir'] + '/train.json', encoding='utf-8'))
dev_data = json.load(open(opt['data_dir'] + '/valid.json', encoding='utf-8'))
id2predicate, predicate2id, id2subj_type, subj_type2id, id2obj_type, obj_type2id = \
    json.load(open(opt['data_dir'] + '/schemas.json', encoding='utf-8'))
...
train_batch = DataLoader(bert_tokenizer, train_data, predicate2id, subj_type2id, obj_type2id, opt['batch_size'])
...
for epoch in range(1, opt['num_epoch']+1):
    ...
    dev_f1, dev_p, dev_r, results = score.evaluate(bert_tokenizer, dev_data, id2predicate, model)
